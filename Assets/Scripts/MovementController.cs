...
namespace SpaceShooter
{
    public class MovementController : MonoBehaviour
    {
        ...
        private void ControlMobile()
        {
            ...
            // Получаем скалярное произведение от -1.0 до +1.0
            // Умножаем вектор направления джойстика на вектор up направления движения корабля
            var dot = Vector2.Dot(dir, m_TargetShip.transform.up);

            // Получаем скалярное произведение от - 1.0 до + 1.0
            // Умножаем вектор направления джойстика на вектор right направления поворота корабля
            ...
            // Вычисляем Max значение между 0 и пересечением векторов при движение
            m_TargetShip.ThrustControl = Mathf.Max(0, dot);
            
            // Вычисляем Max значение между 0 и пересечением векторов при повороте
